...
public class MergeExceptionIteratorOld<T, E extends Exception> implements ExceptionIterator<T, E> {
	...
	public static <I, T, E extends Exception> ExceptionIterator<T, E> buildOfTree(
		...
		int mid = (start + end) / 2;
		return new MergeExceptionIteratorOld<>(buildOfTree(itFunction, comp, array, start, mid),
	...
	public MergeExceptionIteratorOld(ExceptionIterator<T, E> in1, ExceptionIterator<T, E> in2, Comparator<T> comp) {
		this.in1 = in1;
		this.in2 = in2;
		this.comp = comp;
	}
